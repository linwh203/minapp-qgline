    ...
    <div class="my-tab">
      <div class="my-tab-body">
        <div class="my-tab-body-item" @click="bindTab('../my-reward/main')">
          ...
          <img
            src="https://gw.alicdn.com/tfs/TB18fNUqSzqK1RjSZPcXXbTepXa-74-67.png"
        ...
        <div class="my-tab-body-item" @click="bindTab('../my-msg/main')">
          <img
            src="https://gw.alicdn.com/tfs/TB1Z6iGn6TpK1RjSZKPXXa3UpXa-74-66.png"
            class="my-tab-body-item-icon"
          >
      ...
      <div class="my-tab-body">
        <div class="my-tab-body-item" @click="bindTab('../my-note/main')">
          <img
            src="https://gw.alicdn.com/tfs/TB1nVyuxhnaK1RjSZFtXXbC2VXa-67-60.png"
            class="my-tab-body-item-icon"
          >
        ...
        <div class="my-tab-body-item" @click="bindTab('../my-statement/main')">
          <img
            src="https://gw.alicdn.com/tfs/TB1aCaInVzqK1RjSZFoXXbfcXXa-71-65.png"
            class="my-tab-body-item-icon"
          >
      ...
      <div class="my-tab-body">
        <div class="my-tab-body-item" @click="bindTab('../my-suggest/main')">
          <img
            src="https://gw.alicdn.com/tfs/TB1BEeMn7voK1RjSZPfXXXPKFXa-74-66.png"
            class="my-tab-body-item-icon"
          >
        ...
        <div class="my-tab-body-item" @click="bindTab('../my-about/main')">
          <img
            src="https://gw.alicdn.com/tfs/TB1fZ9Gn4TpK1RjSZR0XXbEwXXa-74-65.png"
            class="my-tab-body-item-icon"
          >
...
.container {
  ...
  height: 100%;
  position: relative;
  background: url("https://gw.alicdn.com/tfs/TB1NNxDA9zqK1RjSZPcXXbTepXa-640-1013.png")
    no-repeat top/cover;
  .center();
}
.userPic {
...
.my-tab {
  ...
  &-body {
    ...
    &-item {
      ...
      margin-bottom: 20rpx;
      margin-top: 20rpx;
      background: url("https://gw.alicdn.com/tfs/TB1OCOLn6TpK1RjSZKPXXa3UpXa-290-130.png")
        no-repeat top/cover;
      &-icon {
        width: 72rpx;
        height: 65rpx;
      ...
      &-line {
        width: 1px;
        height: 120rpx;
        background: url("https://gw.alicdn.com/tfs/TB1gnV9A6DpK1RjSZFrXXa78VXa-1-116.png")
          no-repeat top/cover;
      }
    }
    &-line {
      margin: 0 25rpx;
      height: 24rpx;
      background: url("https://gw.alicdn.com/tfs/TB16RB.AVYqK1RjSZLeXXbXppXa-602-18.png")
        no-repeat top/cover;
    }
  }
}
